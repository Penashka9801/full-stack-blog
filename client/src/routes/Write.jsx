    ...
    return <div className="h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6">
        ...
        <form className="flex flex-col gap-6 flex-1 mb-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <select name="cat" id="" className="py-2 rounded-xl bg-white shadow-md">
            ...
            <textarea name="desc" placeholder="A short Description" className="py-4 rounded-xl bg-white shadow-md"/>
